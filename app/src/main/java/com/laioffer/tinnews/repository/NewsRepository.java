...
public class NewsRepository {
    ...
    //create an asynctask to save article to database
    private static class FavoriteAsyncTask extends AsyncTask<Article, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean success) {
            liveData.setValue(success);  //postValue is done in main thread. SetValue is in background task
        }
    }
    ...
    //Livedata will move thread from background to UI thread
